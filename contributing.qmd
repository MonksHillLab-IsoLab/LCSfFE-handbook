# Contributing {.unnumbered #sec-contributing-guide}
...
## Structure of the Handbook {#sec-handbook-structure}
...
- @sec-quarto-basics for everyday Quarto writing patterns
- @sec-pr-workflow for contributing through pull requests
- @sec-publishing-action for understanding how publication works after changes are merged
- @sec-zenodo-releases for the current release and archival workflow

## Quarto Basics for Contributors {#sec-quarto-basics}
...
### Headings and Section Cross-References {#sec-section-crossrefs}
...
### Links, Citations, and File Placement {#sec-links-citations}
...
## Contributing Through Pull Requests {#sec-pr-workflow}
...
## Contributing Without Git {#sec-without-git}
...
## How the Handbook is Published {#sec-publishing-action}
...
## Making Zenodo-Backed Releases {#sec-zenodo-releases}
...
## Before You Open a Pull Request {#sec-before-pr}
