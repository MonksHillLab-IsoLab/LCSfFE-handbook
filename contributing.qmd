# Contributing {#sec-contributing_guide .unnumbered}
...
- See @sec-quarto_basics for everyday Quarto writing patterns
- See @sec-pr_workflow for contributing through pull requests
- See @sec-publishing_action for understanding how publication works after changes are merged
- See @sec-zenodo_releases for the current release and archival workflow
...
``` markdown
[Project repository](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook)
```
