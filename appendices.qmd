...
1.  [Automatic_NDVI.ino](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_A_full_code_listings/Automatic_NDVI/Automatic_NDVI.ino)

2.  [Manual_System_CO2_ET_fluxes.ino](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_A_full_code_listings/Manual_System_CO2_ET_fluxes/Manual_System_CO2_ET_fluxes%20.ino)

3.  [EVE_offline_weather_station.ino](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_A_full_code_listings/EVE_offline/EVE_offline_weather_station.ino)

4.  [EVE_online_weather_station.txt](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_A_full_code_listings/EVE_online/EVE_online_weather_station.txt)

5.  [Mesocosm_System.ino](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_A_full_code_listings/Mesocosm_System.ino)
:::
...
1.  [PAR_Sensor_case.stl](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_B_3D_printing_PCB_board_files/PAR_Sensor_case.stl)

2.  [NDVI_PRI_Sensor_case.stl](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_B_3D_printing_PCB_board_files/NDVI_PRI_Sensor_case.stl)

3.  [Automatic_NDVI_System_case_I.stl](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_B_3D_printing_PCB_board_files/Automatic_NDVI_System_case_I.stl)

4.  [Automatic_NDVI_System_case_II.stl](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_B_3D_printing_PCB_board_files/Automatic_NDVI_System_case_II.stl)

5.  [Automatic_NDVI_AS7262_3_case.stl](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_B_3D_printing_PCB_board_files/Automatic_NDVI_AS7262_3_case.stl)

6.  [Manual_CO2_ET_System_K30_FR_sensor_case.stl](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_B_3D_printing_PCB_board_files/Manual_CO2_ET_System_K30_FR_sensor_case.stl)

7.  [EVE_PAR_sensor_case.stl](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_B_3D_printing_PCB_board_files/EVE_PAR_sensor_case.stl)

8.  [EVE_SHT41_case.stl](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_B_3D_printing_PCB_board_files/EVE_SHT41_case.stl)

9.  [Automatic_NDVI_PRI_System_PCB.zip](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_B_3D_printing_PCB_board_files/Automatic_NDVI_PRI_System_PCB.zip)

10. [Manual_CO2_ET_System_PCB.zip](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_B_3D_printing_PCB_board_files/Manual_CO2_ET_System_PCB.zip)

11. [NiMH_Solar_Trickle_Charger_PCB.zip](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_B_3D_printing_PCB_board_files/NiMH_Solar_Trickle_Charger_PCB.zip)

12. [EVE_Weather_station.zip](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_B_3D_printing_PCB_board_files/EVE_Weather_station.zip)
:::
...
1.  [MonksHillLab_Logger_APP.apk](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_C_other_software/MonksHillLab_Logger_APP.apk)

2.  [Dashboard_Backend_Scripts](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/tree/main/X_Appendix_C_other_software/Dashboard_Backend_Scripts)

3.  [SQL_scheme.txt](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_C_other_software/SQL_scheme.txt)
:::
...
1.  [36h_PAR_comparison_test.csv](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_D_Supporting_Data/36h_PAR_comparison_test.csv) — 36-hour PAR sensor comparison test data

2.  [48h_PAR_comparison_test.csv](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_D_Supporting_Data/48h_PAR_comparison_test.csv) — 48-hour PAR sensor comparison test data

3.  [EVE_Offline_Field_Deployment.csv](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_D_Supporting_Data/EVE_Offline_Field_Deployment.csv) — EVE offline weather station field deployment data

4.  [EVE_Online_Field_Deployment.csv](https://github.com/MonksHillLab-IsoLab/LCSfFE-handbook/blob/main/X_Appendix_D_Supporting_Data/EVE_Online_Field_Deployment.csv) — EVE online weather station field deployment data
:::